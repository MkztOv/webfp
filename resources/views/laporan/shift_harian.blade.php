...
<section class="content-header">
  <h1>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <a href="{{url('/shift_harian')}}">Shift Harian</a>
        </li>
    </ol>
</section>
         ...
         <div class="card-body">
             ...
             <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th style="text-align:center" colspan="1">Shift per Tanggal</th>
                </tr>
                 ...
                 <tr>
                     ...
                     <th style="border-style: solid;border-color: black">11-06</th>
