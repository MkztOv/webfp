...
<section class="content-header">
  <h1>
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="{{url('/gantijadwal')}}">Pengecualian</a>
        </li>
        <li class="active">
            <a href="{{url('/gantijadwal')}}">Ganti Jadwal Kerja</a>
        </li>
    </ol>
</section>
         ...
         <div class="card-body">
             ...
             <table class="table table-bordered">
                 <tr>
                     ...
                     <th style="border-style: solid;border-color: black">Jadwal Kerja Asal</th>
